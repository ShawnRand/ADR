...
#ADR Info 
$Collection = "Production ADR Windows 2012 and 2012 R2"
$ADRName = "$OrgName Production ADR Windows 2012 and 2012 R2"
$DeployPackageLocation = $PackageShare +"\" + $ADRName
$CMPSSuppressFastNotUsedCheck = $true

#Update Info
$Products = "Windows Server 2012","Windows Server 2012 R2"
