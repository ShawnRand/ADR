...
#ADR Info
$Collection = "Production ADR Windows 2008 and 2008 R2"
$ADRName = "$OrgName Production ADR Windows 2008 and 2008 R2"
$DeployPackageLocation = $PackageShare +"\" + $ADRName
$CMPSSuppressFastNotUsedCheck = $true

#Update Info
$Products = "Windows Server 2008", "Windows Server 2008 R2"
