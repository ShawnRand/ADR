...
#ADR Info
$Collection = "Production ADR Windows 2016 and 2019"
$ADRName = "$OrgName Production ADR Windows 2016 and 2019"
$DeployPackageLocation = $PackageShare +"\" + $ADRName
$CMPSSuppressFastNotUsedCheck = $true

#Update Info
$Products = "Windows Server 2016","Windows Server 2019","Windows Server, version 1903 and later"
...
Else
{
    ...
    $Schedule = New-CMSchedule -DayOfWeek Thursday -WeekOrder Second -Start ([Datetime]"20:00")
