...
#ADR Info
$Collection = "Pilot ADR Windows 2016 and 2019"
$ADRName = "$OrgName Pilot ADR Windows 2016 and 2019"
...
Else
{
    ...
    $Schedule = New-CMSchedule -DayOfWeek Tuesday -WeekOrder Second -Start ([Datetime]"20:00")
